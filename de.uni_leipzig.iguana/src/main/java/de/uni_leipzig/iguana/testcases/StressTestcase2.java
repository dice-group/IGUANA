...
public class StressTestcase2 implements Testcase{
	...
	private String tempResultPath=ResultProcessor.TEMP_RESULT_FOLDER;
	...
	private Logger log = Logger.getLogger(StressTestcase2.class.getSimpleName());
	protected Node node;
	...
	private void saveResults() {
		for(ResultSet res : results){
			...
			String path = "."+File.separator+
					tempResultPath+
					File.separator+StressTestcase2.class.getName().replace(".", "-")+
	...
	private void initLogger(){
		LogHandler.initLogFileHandler(log, StressTestcase2.class.getSimpleName());
	}
...
//				ret.reset();
	...
	private void initPatterns(){
		...
		String path = StressTestcase2.class.getSimpleName()+"_"+StringHandler.stringToAlphanumeric(patternFileName);
