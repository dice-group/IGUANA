...
|--------------------------------------|--------------------|-----------------------------|--------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Queries per second                   | `QPS`              |                             | query        | The number of successful and timed out query executions per second.                                                                                                                                                                                                                                                                                                                       |
| Average queries per second           | `AvgQPS`           |                             | task, worker | The average number of successful and timed out query executions per second. It is calculated by dividing the sum of the QPS values of every query the task or worker has by the number of queries.                                                                                                                                                                                        |
...
| Number of queries per hour           | `NoQPH`            |                             | task, worker | The number of executed queries per hour. It is calculated by dividing the number of successfully executed and timed out queries by their sum of time (in hours) it took to execute them. The metric value for the task is the sum of the metric for each worker.                                                                                                                          |
| Query mixes per hour                 | `QMPH`             |                             | task, worker | The number of query mixes executed per hour. A query mix is the set of queries executed by a worker, or the whole task. This metric is calculated for each worker and for the whole task. It is calculated by dividing the number of successful and timed out query executions by the number of queries inside the query mix and by their sum of time (in hours) it took to execute them. |
...
| Penalized Query mixes per hour       | `PQMPH`            | `penalty` (in milliseconds) | task, worker | The same as QMPH, but the execution times for failed queries are set to the penalty value.                                                                                                                                                                                                                                                                                                |
| Penalized Number of queries per hour | `PNoQPH`           | `penalty` (in milliseconds) | task, worker | The number of executed queries per hour. It is calculated by dividing the number of executed queries by their sum of time (in hours) it took to execute them. The metric value for the task is the sum of the metric for each worker. If a query fails, the time it took to execute it is set to the given `penalty` value.                                                               |
