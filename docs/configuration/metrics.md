...
| Penalized Query mixes per hour       | `QMPH`             | `penalty` (in milliseconds) | task, worker | The same as QMPH, but the execution times for failed queries are set to the penalty value.                                                                                                                                                                                                                                                                                                |
