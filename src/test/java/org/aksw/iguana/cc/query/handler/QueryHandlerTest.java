...
//
//
//    public QueryHandlerTest(Map<String, Object> config, String[] expected) throws IOException {
//        this.queryHandler = new QueryHandler(config); // workerID 0 results in correct seed for RandomSelector
//        this.config = config;
...
//        String le = org.aksw.iguana.cc.utils.FileUtils.getLineEnding(Paths.get("src/test/resources/query/source/queries.txt"));
//
...
//        config0.put("path", "src/test/resources/query/source/queries.txt");
//        testData.add(new Object[]{config0, opl});
//
//        // Defaults: caching, linear
//        Map<String, Object> config1 = new HashMap<>();
//        config1.put("path", "src/test/resources/query/source/query-folder");
//        config1.put("format", "folder");
//        testData.add(new Object[]{config1, folder});
//
//        // Defaults: separator("###"), caching, linear
//        Map<String, Object> config2 = new HashMap<>();
//        config2.put("path", "src/test/resources/query/source/separated-queries-default.txt");
//        config2.put("format", "separator");
//        testData.add(new Object[]{config2, separator});
//
//        Map<String, Object> config3 = new HashMap<>();
//        config3.put("path", "src/test/resources/query/source/separated-queries-default.txt");
...
//        config4.put("path", "src/test/resources/query/source/queries.txt");
...
//        config5.put("path", "src/test/resources/query/pattern-query.txt");
