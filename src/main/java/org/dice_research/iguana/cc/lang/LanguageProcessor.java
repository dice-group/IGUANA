package org.dice_research.iguana.cc.lang;

import org.dice_research.iguana.cc.storage.Storable;
import org.dice_research.iguana.cc.lang.impl.SaxSparqlJsonResultCountingParser;
import org.dice_research.iguana.cc.lang.impl.SaxSparqlXmlResultCountingParser;
import org.dice_research.iguana.cc.lang.impl.SparqlCsvResultCountingParser;
import org.dice_research.iguana.cc.lang.impl.SparqlTsvResultCountingParser;
...
public abstract class LanguageProcessor {
    ...
    static {
        ...
        processors.put("application/sparql-results+xml", SaxSparqlXmlResultCountingParser.class);
        processors.put("text/tab-separated-values", SparqlTsvResultCountingParser.class);
        processors.put("text/csv", SparqlCsvResultCountingParser.class);
    }
