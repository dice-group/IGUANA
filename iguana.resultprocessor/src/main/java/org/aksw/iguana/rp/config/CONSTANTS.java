...
public class CONSTANTS {
	...
	/*
	 * RP SPECIFIC CONSTANTS 
	 */
	


	/**
	 * The key for the iguana properties file name
	 */
	...
	/**
	 * Key in the properties where each metric is stated
	 */
	public static final String METRICS_KEY = "iguana.rp.metrics";
	
	/**
	 * Key in the properties where each storages is stated
	 */
